<?php
	...
	function saveUserInterest ($interest) {
		...
		//et mitu korda ei saaks lisada üht hobi
		$stmt = $mysqli->prepare("
		...
		if ($stmt->fetch()){
			//kui oli olemas juba selline rida
			echo "juba olemas";
			//pärast return-i midagi edasi ei tehta funktsioonis
			return;
		}
		
		//vanemates php versioonides
		//$stmt->close();
